...
const getClientData = (email) => {
    return new Promise((resolve, reject) => {
        const query = 'SELECT client_id, company, email, company_short_name FROM client WHERE email = ?';
...
const getInternalData = (identifier) => {
    return new Promise((resolve, reject) => {
        const query = 'SELECT int_id, emp_id, name, email, mobile, am_id, designation_id FROM internal WHERE email = ? OR emp_id = ?';
